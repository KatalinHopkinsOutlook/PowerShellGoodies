...
#>
	...
	$psCommand =  "`n robocopy """ + 
			...
			"/S /COPY:DAT /DCOPY:DAT /MOVE /R:3 /W:3 /MT:16 " + 
			"/TEE /LOG:""" +
			$LogFile + "`""     

	Write-Host -ForegroundColor Yellow $psCommand
...
#/e = include empty subdirectories
	robocopy $Source $Destination /S /COPY:DAT /DCOPY:DAT /MOVE /R:3 /W:3 /MT:16 /TEE /LOG:$LogFile

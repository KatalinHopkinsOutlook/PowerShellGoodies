...
$Source="\\DS224\MS-Surface-E6F1US5\kahopkin\OneDrive-Live\OneDrive\Certificates"
...
{	
	...
	Write-Host -ForegroundColor Green "`nCLONING DESTINATION DIRECTORY STRUCTURE..."	
	...
	Write-Host -ForegroundColor Green -BackgroundColor Black  "`n`$SourceParentFolderPath=" -NoNewline
	...
	$psCommand =  "`n robocopy " + "`"" + $SourceParentFolderPath + "`" " + "`"" + $DestinationParentFolderPath + "`"" + " /DCOPY:DAT /E /XF * /TEE /LOG:`"" + $LogFile + "`""
	#$psCommand =  "`n robocopy " + "`"" + $SourceParentFolderPath + "`" " + "`"" + $DestinationParentFolderPath + "`"" + " /DCOPY:DAT /E /XF *"
	Write-Host -ForegroundColor Cyan $psCommand
	
	robocopy $SourceParentFolderPath $DestinationParentFolderPath /DCOPY:DAT /E /XF * /TEE /LOG:$LogFile

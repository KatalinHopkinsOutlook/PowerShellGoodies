...
$Source = "C:\Users\kahopkin\OneDrive - Microsoft\Downloads\Executables\StartAllBack"
$Destination = "C:\Users\kahopkin\OneDrive - Microsoft\Downloads\Executables\WindowsHacks"

robocopy $Source $Destination /S /COPYALL /DCOPY:DAT /MOVE
